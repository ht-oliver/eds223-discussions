...
### 3) Find geographic extent of speices occurrence and crop raster

```{r}
# Find geographic extent of species occurrence, crop raster
magpie_sf <- magpie |> 
  rename(long = longitude,
         lat = latitude) |> 
  drop_na(long, lat) |> # Drop NAs in long and lat
  st_as_sf(coords = c("long", "lat"), crs = 4326) # Reproject long/lat to WGS 84
...
### 4) Extract points from speices occurrence
...
### 5) Create background values and extract values
